...
/**
 * 요구사항 -> AOP를 사용하지 않고 공통 기능을 처리 또는 횡단 관심사를 처리
...
public class Spring08AopBasicApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		//DI 의존성 주입이 잘 되었음을 확인, memberServiceImple에 @Service
		//ProducserviceImpl에 @Service 처리를 했으므로 됨
