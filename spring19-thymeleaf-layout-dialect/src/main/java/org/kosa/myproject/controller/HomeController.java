...
public class HomeController {
	...
	@GetMapping("/study1")//HandlerMapping이 연결을 도와줌
	public String study1(Model model) {
		model.addAttribute("member", new Member("java","A","손흥민","런던"));
		return "step01-text-object-expression";//viewResolver가 도와줌
	}
	@GetMapping("/study2")//HandlerMapping이 연결을 도와줌
	public String study2(HttpSession session) {
		...
		return "step02-form-object-expression";//viewResolver가 도와줌
	}
	@GetMapping("/study3")
	...
	public String study5(Model model) {
		model.addAttribute("", new MyProduct(1,"테라","하이트진로",1700,true));
		model.addAttribute("size", "M");
		return "step05-if-unless-switch"; //view name 을 return
	}
	@GetMapping("/study6")
	public String study6(Model model) {
		...
		List<Member> list=List.of(
				...
				new Member("thymeleaf","c","황희찬","울버햄트")
				);
	...
	public String study10Two(Model model) {
		model.addAttribute("message", "메인 2 page 컨텐트입니다");
		return "step10-main2";
	}
	@GetMapping("/study11")
	public String study11(Model model) {
		return "step11-main1";
	}
	@GetMapping("/study11-2")
	public String study11Two(Model model) {
		return "step11-main2";
	}
}
